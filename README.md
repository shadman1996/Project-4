...
# 4. Run Secured HITL Demo
chainlit run app_secured.py
```

## Project Structure
- `app.py`: Unguarded Chainlit dashboard (shows prompt injection vulnerabilities)
- `app_secured.py`: Secured Chainlit dashboard (shows HITL defense)
