/**
 * Project 4 — Interactive Tutorial v3
 * Click-driven walkthrough: spotlight → explain → user clicks → advance.
 * Features: mini terminal console, HITL preview, agent pipeline preview.
 */
(function () {
  "use strict";
